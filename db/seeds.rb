...
User.create({email: "jfk303@nyu.edu", password: "password", artist_name: "NoGod", profile_picture: File.new("public/seed_images/nogod.jpg")})
User.create({email: "email1", password: "password", artist_name: "oddity", profile_picture: File.new("public/seed_images/oddity.jpg")})
User.create({email: "email2", password: "password", artist_name: "Before Before", profile_picture: File.new("public/seed_images/beforebefore.jpg")})
User.create({email: "email3", password: "password", artist_name: "FLIP IN", profile_picture: File.new("public/seed_images/flipin.jpg")})
User.create({email: "email4", password: "password", artist_name: "White", profile_picture: File.new("public/seed_images/white.jpg")})
User.create({email: "email5", password: "password", artist_name: "Street Grief", profile_picture: File.new("public/seed_images/streetgrief.jpg")})
User.create({email: "email6", password: "password", artist_name: "OverHERE", profile_picture: File.new("public/seed_images/overhere.jpg")})
User.create({email: "email7", password: "password", artist_name: "Not There", profile_picture: File.new("public/seed_images/notthere.jpg")})
User.create({email: "email8", password: "password", artist_name: "The Mind's Pupil", profile_picture: File.new("public/seed_images/themindspupil.jpg")})
...
Photo.create({user_id: 1, album_id: 1, picture: File.new("public/seed_images/album1.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("public/seed_images/album2.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("public/seed_images/album3.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("public/seed_images/album4.jpeg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("public/seed_images/album5.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("public/seed_images/album6.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("public/seed_images/album7.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("public/seed_images/album8.jpeg")})
