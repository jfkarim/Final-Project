...
Photo.create({user_id: 1, album_id: 1, picture: File.new("app/assets/images/album1.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("app/assets/images/album2.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("app/assets/images/album3.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("app/assets/images/album4.jpeg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("app/assets/images/album5.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("app/assets/images/album6.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("app/assets/images/album7.jpg")})
Photo.create({user_id: 1, album_id: 1, picture: File.new("app/assets/images/album8.jpeg")})
